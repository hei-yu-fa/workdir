...
var selectors = [audioInputSelect, audioOutputSelect, videoSelect, videoSelect2];
...
function changeAudioDestination2() {
  var audioDestination = audioOutputSelect.value;
  attachSinkId(videoElement2, audioDestination);
}
...
function start() {
  ...
  var constraints2 = {
    audio: {deviceId: audioSource ? {exact: audioSource} : undefined},
    video: {deviceId: videoSource ? {exact: videoSource2} : undefined}
  };
