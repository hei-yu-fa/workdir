...
window.onload = function () {
	var ws = (0, _socket2.default)('http://localhost:3000');
	...
	function create_pic(shuffled_array) {
		for (var _i = 1; _i <= 9; _i++) {
			if (shuffled_array[_i - 1][0] == _i) {
				nomove_arr.push(_i);
				console.log('nomove push, ', _i);
			}
		}
